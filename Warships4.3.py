...
# Author: Ryan Slater
# Date: 9/29/2017
# Changes: Improved setShips() function to allow for resetting ships and user-decided placement order
#==============================================================================
...
class player():
    ...
    def __setShip__(self, length, shipName, shipIndex):
        print(500*"\n")
    ...
    def setShips(self, player):
        ...
        self.__setShip__(5, "carrier", 'C')
        self.__setShip__(4, "battleship", 'B')
        self.__setShip__(3, "cruiser", 'R')
        self.__setShip__(3, "submarine", 'S')
        self.__setShip__(2, "destroyer", 'D')
